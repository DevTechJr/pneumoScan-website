        ...
        <div className="w-1/2 p-5 bg-primary mx-3 rounded-2xl flex flex-col">
          ...
          <div className="p-5 rounded-2xl bg-primary-content">
            <p className="text-md font-medium text-primary">
              ...
              compromised immune systems. The most common cause of bacterial
              pneumonia is Streptococcus pneumoniae, but other bacteria, such as
              Haemophilus influenzae and Staphylococcus aureus, can also cause
              the disease. Viral pneumonia, which is typically less severe than
              bacterial pneumonia, is caused by viruses such as the influenza
              virus and the respiratory syncytial virus (RSV). Pneumonia can be
              treated with antibiotics, antiviral medications, and supportive
              care, such as oxygen therapy and hydration. Vaccines are available
              to prevent some types of pneumonia.
            </p>
          </div>
        </div>
        <div className="mx-2 grid grid-cols-2 gap-5 h-full">
          <img
            className="object-cover w-full h-56 col-span-2 rounded shadow-lg rounded-2xl"
          ...
          />
          <img
            className="object-cover w-full h-56 rounded shadow-lg rounded-2xl"
