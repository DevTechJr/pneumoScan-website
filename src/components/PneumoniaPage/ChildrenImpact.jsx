...
const ChildrenImpact = () => {
  return (
    <div className="w-full flex flex-col justify-center items-center mb-5 mt-5 p-10 bg-primary rounded-xl">
      <div className="w-full flex lg:p-10 lg:flex-row md:flex-col flex-col items-center p-8 bg-white rounded-xl">
        {/* Box num 1 */}
        <div className="lg:w-1/2 md:w-1/2 w-full p-5 bg-primary mx-3 rounded-2xl flex flex-col drop-shadow-xl">
          <h1 className="text-center text-white font-bold lg:text-2xl md:text-lg text-lg my-3">
          ...
          <div className="p-5 rounded-2xl bg-primary-content ">
            <p className="lg:text-md md:text-sm text-sm font-medium text-grey-900">
              ...
              <span className="hidden md:block">
                ...
                few decades. According to data from the World Health
                Organization (WHO), the global pneumonia death rate fell by 73%
                between 1990 and 2019, from 73 deaths per 100,000 people to 20
                deaths per 100,000 people. This decline is largely due to
                improved access to vaccines, better treatment and care, and
                increased efforts to prevent and control the spread of
                pneumonia.
              </span>
            </p>
          </div>
        </div>
        <div className="mx-2 h-full md:w-1/2 w-full md:mt-0 mt-6">
          <iframe
            src="https://ourworldindata.org/grapher/pneumonia-death-rates-age-standardized?time=latest"
            loading="lazy"
            className="w-full h-96 rounded-2xl border-solid border-8 border-primary drop-shadow-xl"
          ></iframe>
          <div className="hidden md:block p-5 rounded-2xl bg-primary-content mt-3 border-solid border-8 border-primary drop-shadow-xl">
